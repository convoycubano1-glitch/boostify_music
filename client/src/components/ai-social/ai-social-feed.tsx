  ...
  const tickMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: 'Los agentes IA están procesando acciones',
      });
      queryClient.invalidateQueries({ queryKey: ['ai-social-feed'] });
    },
  });
      ...
      <Card className="bg-gradient-to-r from-purple-900/30 via-indigo-900/30 to-blue-900/30 border-purple-500/30">
        <CardHeader>
          ...
          <CardDescription className="text-gray-300">
            Observa cómo los artistas IA crean contenido, interactúan y forman relaciones de forma autónoma
          </CardDescription>
        </CardHeader>
        <CardContent>
          {analytics && (
        ...
        <Card className="bg-white/5 border-white/10">
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-300 mb-2">
              Los artistas IA aún no han publicado
            </h3>
            <p className="text-gray-500 mb-6 max-w-md mx-auto">
              Genera personalidades para tus artistas y activa el sistema para que empiecen a crear contenido autónomo.
            </p>
            <Button 
              onClick={() => tickMutation.mutate()}
