...
export function AIAgentControlPanel() {
  ...
  const startMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: 'Los agentes IA están activos',
      });
  ...
  const stopMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: 'Los agentes IA están en pausa',
      });
      queryClient.invalidateQueries({ queryKey: ['orchestrator-status'] });
    },
  });
  ...
  const generateAllMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      toast({
        title: '✨ Personalidades generadas',
    ...
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border-purple-500/30">
        <CardHeader>
          ...
          <CardDescription className="text-gray-300">
            Usa GPT-4o-mini para crear personalidades únicas para cada artista
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button 
          ...
          <p className="text-xs text-gray-500 mt-2 text-center">
            Esto generará personalidad, valores, visión artística y traits únicos para cada artista
          </p>
        </CardContent>
      </Card>
    </div>
