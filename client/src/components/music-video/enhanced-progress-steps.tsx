...
// Importamos los efectos visuales mejorados
import {
  StepParticles,
              ...
              <React.Fragment key={step.id}>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    {/* Efectos visuales específicos para cada paso */}
                    {isActive && <StepParticles stepId={step.id} />}
                    
                    {/* Efecto especial para pasos completados */}
                    {isCompleted && <CompletedStepEffect />}
...
// Exportamos los mismos pasos del flujo de trabajo para creación de videos musicales
