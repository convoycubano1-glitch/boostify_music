        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              >
                <Badge 
                  className="mb-4 bg-orange-500/20 text-orange-400 border-orange-500/30 px-4 py-1 text-sm inline-block"
                  variant="outline"
                >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 py-4">
                  <Button
                    size="lg"
