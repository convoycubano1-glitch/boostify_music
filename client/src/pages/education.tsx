  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        // Si no hay cursos, crear automáticamente desde el backend
        if (coursesData.length === 0) {
          logger.info("No courses found. Calling backend to create sample courses...");
          try {
            await fetch('/api/education/create-sample-courses', { method: 'POST' });
