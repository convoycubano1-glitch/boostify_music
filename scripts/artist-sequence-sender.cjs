                ...
                <tr>
                  <td align="center">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        <td style="padding: 0 8px;"><a href="${URLS.home}" style="font-size: 12px; color: #f97316; text-decoration: none;">🌐 boostifymusic.com</a></td>
                        <td style="padding: 0 8px;" class="mobile-hide"><a href="${URLS.myArtists}" style="font-size: 12px; color: #10b981; text-decoration: none;">🎨 Create Artist Page</a></td>
                      </tr>
                    </table>
