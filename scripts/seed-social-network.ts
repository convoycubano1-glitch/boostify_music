...
async function seedSocialNetwork() {
  console.log("🌱 Starting social network seed process...");
  ...
  try {
    ...
    const interests = [
      ["música", "producción musical", "marketing digital", "redes sociales"],
      ["songwriting", "audio engineering", "artist development", "industry networking"],
      ["composición", "tecnología musical", "promoción artística", "educación musical"],
      ["performance", "mixing", "branding", "distribution"],
      ["instrumentos musicales", "colaboraciones", "monetización", "tendencias musicales"]
    ];
    ...
    const postContents = [
      "¿Alguien tiene consejos para promocionar música en Spotify?",
      "Just finished my new track! Can't wait to share it with you all.",
      "Estoy buscando colaboradores para mi próximo álbum. ¿Alguien interesado?",
      ...
      "¿Cuál es la mejor estrategia para crecer en redes sociales como artista?",
      "Sharing my journey from bedroom producer to signed artist",
      "¿Qué opinan de las nuevas plataformas de streaming?",
      "Anyone else finding TikTok great for music promotion?",
      "Estoy organizando un concierto virtual. ¿Quiénes se unen?",
      "Just got my first 10k streams! Thank you to everyone who supported me",
      "¿Qué equipo de grabación recomiendan para principiantes?",
      "Thoughts on AI music production tools? Helpful or harmful?",
      "Necesito consejos para negociar con sellos discográficos"
    ];
        ...
        if (Math.random() > 0.5) {
          ...
          if (postAuthor.isBot) {
            ...
            const replies = [
              ...
              "Buena observación, no lo había pensado así.",
    ...
    console.log("✅ Social network seed completed successfully!");
  } catch (error) {
