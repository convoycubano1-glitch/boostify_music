          ...
          <tr>
            <td style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 25px; text-align: center;">
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: 15px auto 0 auto;">
                <tr>
                  <td style="padding: 0 8px;"><a href="https://boostifymusic.com" style="font-size: 11px; color: #f97316; text-decoration: none;">🌐 boostifymusic.com</a></td>
                  <td style="padding: 0 8px;"><a href="https://wefunder.com/boostify.music" style="font-size: 11px; color: #10b981; text-decoration: none;">💰 wefunder.com/boostify.music</a></td>
                </tr>
              </table>
            </td>
          </tr>
