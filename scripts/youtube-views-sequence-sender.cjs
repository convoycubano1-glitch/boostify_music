              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td align="center">
                    ...
                    <a href="${URLS.youtubeViews}" style="display: inline-block; padding: 10px 20px; background: rgba(239, 68, 68, 0.15); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: 8px; font-size: 12px; color: #ef4444; text-decoration: none; font-weight: 600;">🚀 Start Growing Free</a>
