// Servidor Express simplificado que muestra una página de Boostify completamente funcional
...
console.log('⚡ Iniciando servidor simplificado de Boostify Music');
...
// HTML de la landing page completa y funcional
app.get('*', (req, res) => {
  console.log(`Sirviendo página para ruta: ${req.originalUrl}`);
