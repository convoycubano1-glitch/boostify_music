        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            <Link href="#how-it-works">
              <a className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-orange-500 to-red-500 px-6 py-3 font-medium text-white shadow-lg hover:from-orange-600 hover:to-red-600 transition-all duration-200 text-lg">
                Comenzar ahora
              </a>
            </Link>
            <Link href="#benefits">
              <a className="inline-flex items-center justify-center rounded-lg border border-orange-500/30 bg-black/30 backdrop-blur-sm px-6 py-3 font-medium text-white hover:bg-black/50 transition-all duration-200 text-lg">
    ...
    <section id="benefits" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 text-sm font-semibold bg-orange-100 text-orange-800 rounded-full mb-4">
            BENEFICIOS
          </span>
...
const FAQSection = () => {
  ...
  return (
    <section className="py-20 bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="inline-block px-3 py-1 text-sm font-semibold bg-orange-500/20 text-orange-400 rounded-full mb-4">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-4 font-medium text-orange-600 shadow-lg hover:bg-gray-100 transition-all duration-200 text-lg">
              Comienza a tokenizar
            </button>
            <Link href="/contact">
              <a className="inline-flex items-center justify-center rounded-lg border border-white px-6 py-4 font-medium text-white hover:bg-white/10 transition-all duration-200 text-lg">
                Contáctanos
              </a>
            </Link>
          </div>
